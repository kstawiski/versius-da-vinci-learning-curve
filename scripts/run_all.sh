...
if [ -d manuscript ]; then  # manuscript assembly, only inside the manuscript workspace
  python3 scripts/13_assemble_check.py manuscript/MANUSCRIPT_v10.md manuscript/MANUSCRIPT_v10_assembled.md
  python3 scripts/14_verify_numbers.py manuscript/MANUSCRIPT_v10_assembled.md | tail -1
  python3 scripts/17_assemble_supplement.py manuscript/SUPPLEMENT_v4_source.md manuscript/SUPPLEMENT_v4.md
fi
